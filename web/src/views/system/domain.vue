    ...
    computed: {
      tableColumn(){
        return [
          ...
          {prop:"proAddress",label:"生产环境地址",filterable:true,isShowFilter:true,iSpan:6,width:"200"},
          {prop:"devAddress",label:"开发环境地址",filterable:true,isShowFilter:true,iSpan:6,width:"200"},
      ...
      editColumn(){
        return [
          {prop:"name",label:"服务",iType:'text',required:true,iSpan:24},
          {prop:"proAddress",label:"生产环境地址",iType:'text',iSpan:12},
          {prop:"devAddress",label:"开发环境地址",iType:'text',required: true,iSpan:12,},
