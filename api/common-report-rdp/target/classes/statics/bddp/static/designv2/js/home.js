    ...
    getJSONFileData("../../bddp/getBddpFolders", function (res) {
        if (res.code == 0) {
            ...
            for (var i = 0; i < fileArrs.length; i++) {
                var file = fileArrs[i];
                var ul = $('<ul class="lt-tr"><li class="lt-td uuid"></li><li class="lt-td image"></li><li class="lt-td filename"></li><li class="lt-td lasttime"></li><li class="lt-td ctrls"><span class="ctrl ctrl-export">导出</span><span class="ctrl ctrl-phone">移动端</span><span class="ctrl ctrl-edit">修改</span><span class="ctrl ctrl-del">删除</span></li></ul>');
                ...
                ul.find(".ctrl-export").bind("click", function () {
                    location.href = "../../bddppage/exportBddp?uuid=" + $(this).parents(".lt-tr").data("name") + "&bdname=" + $(this).parents(".lt-tr").data("bdname")
                    return false;
                });
                ul.find(".ctrl-phone").bind("click", function () {
                    window.open("../../bddpshow/showphone/" + $(this).parents(".lt-tr").data("name"));
                    return false;
                });
