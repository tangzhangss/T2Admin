...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '打开方式', field: 'openMode', align: 'center', valign: 'middle', sortable: true, width: '100px',formatter: function(item, index){
            if(item.openMode == "_self"||item.openMode==""||item.openMode==null){
                return '<span class="label label-primary">当前窗口</span>';
            }
            if(item.openMode === "_parent"){
                return '<span class="label label-primary">父窗口</span>';
            }
            if(item.openMode === "_blank"){
                return '<span class="label label-success">新窗口</span>';
            }
            if(item.openMode === "_top"){
            	return '<span class="label label-warning">主窗口</span>';
            }
        }},
